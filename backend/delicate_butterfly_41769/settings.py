"""
Django settings for delicate_butterfly_41769 project.
...
ROOT_URLCONF = 'delicate_butterfly_41769.urls'
...
WSGI_APPLICATION = 'delicate_butterfly_41769.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_butterfly_41769 API",
    "DESCRIPTION": "API documentation for delicate_butterfly_41769 App",
    "VERSION": "v1",
}
